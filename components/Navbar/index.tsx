...
const Navbar = () => {
    ...
    const [providers, setProviders] = useState<Record<LiteralUnion<BuiltInProviderType, string>, ClientSafeProvider> | null | undefined>();
                ...
                isMobile && (
                    ...
                    <div id='mobile-menu'>
                        <div className='space-y-1 px-2 pb-3 pt-2'>
                            <Link
                                href='/'
                                className={`${pathname === '/' ? 'bg-gray-900' : ''} hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium`}
                            >
                                Home
                            </Link>
                            <Link
                                href='/properties'
                                className={`${pathname === '/properties' ? 'bg-gray-900' : ''} hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium`}
                            >
                                Properties
                            </Link>
                            {
                                session && (
                                    ...
                                    <Link
                                        href='/properties/add'
                                        className={`${pathname === '/properties/add' ? 'bg-gray-900' : ''} hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium`}
                                    >
                                        Add Property
                                    </Link>
                                )
